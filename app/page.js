  ...
  return (
    <div className="wrap">
      ...
      <section id="team" className="section">
        ...
        <p style={{ fontSize: 15, lineHeight: 1.7, color: "var(--ink)", maxWidth: 620, marginBottom: 14 }}>
        ...
        <p style={{ fontSize: 15, lineHeight: 1.7, color: "var(--ink)", maxWidth: 620, marginBottom: 26 }}>
